        			...
        			'<div class="modal-content"> ' +
        				'<div class="modal-body">' +
        	      		...
        	      		'<div class="modal-footer">'+
        	        		'<button class="btn btn-xs btn-primary" onclick="$(\'#windowAlertModal\').modal(\'hide\');" style="border-width: 2px;" data-dismiss="modal" aria-hidden="true">关闭</button>'+
        	      		'</div>'+
        			'</div>'+
        		'</div>'+
        	'</div>');
    		  	...
    		  	'<div class="modal-dialog" style="width:350px;"> '+
    		  		'<div class="modal-content" > '+
    		  			'<div class="modal-body" style="padding:15px;"> '+
    		  				...
    		  				'<p class="word-break-all" style="margin-top:30px;"> alert text </p> '+
    		  			'</div> '+
	    		  		'<div class="modal-footer"> '+
	    		  			...
	    		  			'<button class="btn btn-xs btn-primary" id="btn_index_no" style="border-width: 2px;" data-dismiss="modal" aria-hidden="true">取消</button> '+
	    		  		'</div> '+
    		  		'</div> '+
    		  	'</div> '+
    		  '</div>');
