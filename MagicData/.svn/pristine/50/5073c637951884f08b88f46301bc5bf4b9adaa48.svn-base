...
//	@Field("receiveds")
	...
	private boolean ifhavePE;//是否有PE
	public CopyOfEmail() {}

	public boolean isIfhavePE() {
		return ifhavePE;
	}

	public void setIfhavePE(boolean ifhavePE) {
		this.ifhavePE = ifhavePE;
	}
