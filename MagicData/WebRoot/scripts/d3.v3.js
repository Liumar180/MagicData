!function() {
  ...
  d3.behavior.zoom = function() {
    ...
    /**********************************/
    //xuwenjia自定义
//    zoom.custom_scale=function(z,p){
//      var k = Math.log(z) / Math.LN2;
//      zoomTo(this, p || center, location( p || center),k);
//    };
//    zoom.localion=function(p){return location(p);}
    zoom.custom_scale=function(z,p){
      var dispatch = event.of(this, arguments), l = location(p || center), k = Math.log(z) / Math.LN2;
      zoomstarted(dispatch);
      scaleTo(Math.pow(2,k));
      translateTo(p || center, l);
      zoomed(dispatch);
      zoomended(dispatch);
    };
    zoom.localion=function(p){return location(p);}
